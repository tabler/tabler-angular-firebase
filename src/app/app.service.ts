...
export class AppService {
  ...
  public init() {
    ...
    this.ui.appLogo = 'assets/tabler.svg'
    this.ui.headerSubNav = [
      {
        label: 'Source Code',
        labelClass: 'd-none d-lg-inline',
        link: 'https://github.com/tabler/tabler-angular-firebase',
        linkClass: 'btn btn-sm btn-outline-primary ml-2',
        icon: 'fe fe-github mr-1',
      },
    ]
    this.ui.footerText = `
      Copyright © 2018 <a href="https://github.com/tabler/tabler-angular-firebase">tabler-angular-firebase</a>.
      Tabler by <a href="https://github.com/codecalm" target="_blank">@codecalm</a>.
      Tabler for Angular by <a href="https://github.com/beeman" target="_blank">@beeman</a>.
      MIT Licensed
    `
    this.ui.footerNav = [
      {
